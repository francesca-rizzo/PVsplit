...
gname = 'serra_00_snap_23_h1842_i_1.38_ca_2.9_4_2_3.alma_0.05arcsec_0' 
outfolder = '/Users/francescarizzo/Documents/projects/CII_Dynamics_at_EoR/Raw_simulated_CII_cubes/serra_00_s23_h1842/serra_00_snap_23_h1842_i_1.38_ca_2.9_4_2_3/output/serra_00_snap_23_h1842_i_1.38_ca_2.9_4_2_3.alma_0.05arcsec_0/' 
twostage = 1 
plotmask = 1 
...
image = fits.open('serra_00_snap_23_h1842_i_1.38_ca_2.9_4_2_3.alma_0.05arcsec.fits') 
...
for k in range (len(files_mod)): 
	...
	for j in range (0,3): 
		for i in range (0,5): 
			...
			velo_kms = (chan+1-1)*-31.3508+532.964
			...
			if (j==i==0): 
				...
				bmaj, bmin, bpa = 7.04149/float(xmax-xmin), 5.3785/float(ymax-ymin),17.8726
